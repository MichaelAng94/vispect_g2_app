...
public class BluetoothLeClass{
    ...
    /**
     * Connects to the GATT server hosted on the Bluetooth LE ADASDevice.
     *
     * @param address The ADASDevice address of the destination ADASDevice.
     *
    ...
    public boolean connect(final String address) {
        ...
        // Previously connected ADASDevice.  Try to reconnect.
        ...
        // We want to directly connect to the ADASDevice, so we are setting the autoConnect
        // parameter to false.
    ...
    /**
     * After using a given BLE ADASDevice, the app must call this method to ensure resources are
     * released properly.
     */
    public void close() {
    ...
    /**
     * Retrieves a list of supported GATT services on the connected ADASDevice. This should be
