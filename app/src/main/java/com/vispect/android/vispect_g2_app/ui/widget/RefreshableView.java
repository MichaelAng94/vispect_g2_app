...
public class RefreshableView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initHeaderView() {
        ...
        // 设置最后刷新时间
        tvLastUpdateTime.setText(AppContext.getInstance().getResources().getString(R.string.updated_at)+ getLastUpdateTime());
    ...
    private void refreshHeaderView() {
        switch (currentState) {
            case DOWN_PULL_REFRESH : // 下拉刷新状态
                tvState.setText(AppContext.getInstance().getResources().getString(R.string.release_to_refresh));
            ...
            case REFRESHING : // 正在刷新中状态
                ...
                tvState.setText(AppContext.getInstance().getResources().getString(R.string.refreshing));
                break;
            default :
                break;
        }
